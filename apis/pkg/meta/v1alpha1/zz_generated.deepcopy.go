...
func (in *MetaSpec) DeepCopyInto(out *MetaSpec) {
	*out = *in
	...
	if in.MetadataExtensions != nil {
		in, out := &in.MetadataExtensions, &out.MetadataExtensions
		*out = new(StructuredMeta)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StructuredMeta) DeepCopyInto(out *StructuredMeta) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StructuredMeta.
func (in *StructuredMeta) DeepCopy() *StructuredMeta {
	if in == nil {
		return nil
	}
	out := new(StructuredMeta)
